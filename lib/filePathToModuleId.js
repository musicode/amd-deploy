 ...
 * @param {Object} amdConfig 包含 baseUrl paths 等配置项
 * @return {string} 文件路径
 */
module.exports = exports = function (filePath, amdConfig) {

    var baseUrl = amdConfig.baseUrl.trim();
    ...
    var packages = amdConfig.packages || [ ];
